export const PROJECTS = [
  ...
  {id:3,title:"ROMARA Tours & Travel",desc:"Front end for a Kenyan safari and vehicle-hire operator.",longDesc:"Front end for a Kenyan safari and vehicle-hire operator. Experiences, destinations and resources are organised around two booking routes, safari and vehicle hire, with a WhatsApp channel alongside the enquiry form for direct contact.",tags:["Web App","Frontend"],emoji:"◈",cardBg:"#3A3122",stack:["React","Vercel"],liveUrl:"https://romara-frontend-theta.vercel.app/",client:"Safari & Vehicle Hire Operator",year:"2025",outcome:"Live",category:"SAFARI & VEHICLE HIRE",image:"/romara.jpg"}
];

export const SKILLS = [
  {label:"React & JavaScript",pct:92},
  {label:"UI/UX Design (Figma)",pct:88},
  {label:"TailwindCSS / CSS3",pct:90},
  {label:"Node.js & REST APIs",pct:75},
  {label:"Animation (GSAP/Framer)",pct:82},
